...
_PREDEFINED_SPLITS_TOMO = {}
_PREDEFINED_SPLITS_TOMO["tomo_mito"] = {
    # maskcut annotations
...
def register_all_tomo(root):
    for dataset_name, splits_per_dataset in _PREDEFINED_SPLITS_TOMO.items():
        for key, (image_root, json_file) in splits_per_dataset.items():
            # Assume pre-defined datasets live in `./datasets`.
            register_coco_instances(
                key,
